...
ces_first_layer_ene_prod_fixed
"""
...
class CESModel(tf.Module):
    def __init__(self):
        ...
        # Directly estimate upsilon
        self.upsilon = tf.Variable(1.0, dtype=tf.float32, trainable=True)
...
def extract_results(model, loss=None, bootstrap_id=None):
    ...
    result = {
        ...
        "rho": rho_estimated.numpy() if hasattr(rho_estimated, "numpy") else rho_estimated,
...
output_path = Path.cwd() / "ces_first_layer_ene_prod_results.xlsx"
