...
% Use a reproducible random stream
...
syms gamma_f beta_oilgas beta_coal rho_f y_oil y_gas y_coal upsilon
...
parameters = [beta_oilgas, beta_coal, rho_f, gamma_f, upsilon];
...
disp('Estimated parameters: beta_oilgas beta_coal rho_f gamma_f upsilon');
...
% Use quieter options inside parfor to avoid excessive output
...
third_layer_bootstrap_table = array2table( ...
    bootstrap_params, ...
    'VariableNames', {'beta_oilgas', 'beta_coal', 'rho_f', 'gamma_f', 'upsilon'} ...
);
...
var_names = {'beta_oilgas', 'beta_coal', 'rho_f', 'gamma_f', 'upsilon', 'MSE'};
...
output_file = fullfile(cd, "third_layer_upsilon_sqp.xlsx");
